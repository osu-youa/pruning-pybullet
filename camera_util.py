...
CAMERA_BASE_OFFSET = np.array([0.082767, 0.008, 0.082929])
...
def compute_eye_transform(pan, xyz_offset=None, base_tf=None):
...
def get_view_matrix(pan, xyz_offset, base_tf=None):
    import pybullet as pb

    tf = compute_eye_transform(pan, xyz_offset, base_tf=base_tf)
    viewpoint = tf[:3,3]
